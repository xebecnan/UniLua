  ...
  public class LuaTable {
    ...
    */
    private int FindIndex(StkId key) {
      ...
      for (;;) {
        ...
        // key not found
        if (n == null) {
          L.G_RunError("invalid key to 'next'");
        }
      }
    }
    ...
    */
    ...
    public static LuaTable Clone(LuaTable other) {
      ...
      if (other.ArrayPart == null) ret.ArrayPart = null;
      else {
      ...
      if (other.HashPart == null) ret.HashPart = null;
      else {
